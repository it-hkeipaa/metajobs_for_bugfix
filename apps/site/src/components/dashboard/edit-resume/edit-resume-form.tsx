...
const EditResume = () => {
  ...
  const {
    ...
    defaultValues: {
      ...
      workingRate: resumeData?.workingRate,
  ...
  React.useEffect(() => {
    if (resumeData && !isDirty) {
      ...
      setValue("fullName", resumeData?.name);
      setValue("email", resumeData?.email);
      setValue("region", resumeData?.region);
      setValue("professionalTitle", resumeData?.professionalTitle);
      setValue("location", resumeData?.location);
      setValue("video", resumeData?.video);
      // setValue("category", resumeData?.category);
      setCategoryName(getCategoryName ? [getCategoryName] : ("" as any));
      setValue("category", getCategoryName ? [getCategoryName] : "");
      setValue("workingRate", resumeData?.workingRate);
      setValue("educations", resumeData?.education);
      setValue("resumeContent", resumeData?.resumeContent);
      setValue("skills", resumeData?.skills);
      setValue("url", resumeData?.url);
      setValue("experiences", resumeData?.experience);
      setPhotoImage(resumeData?.photo);
    }
  }, [data, resumeData, setValue]);
  ...
  const onSubmitHandler = async (data: any) => {
    ...
    formData.append("category", data.category[0].categoryTitle); // return category title
  ...
  const photoFile = register("photoFile" as any);
  const resumeFile = register("resumeFile" as any);

  return (
    <section className="mb-6">
      <div className="rounded-lg shadow-lg bg-white">
        <div className="h-16 bg-themeDark mb-8 flex items-center px-10 rounded-lg">
          <p className="text-xs text-white">Resume Details</p>
        </div>
        {/* Loader */}
        {!data && (
              ...
              <div>
                <div className="flex flex-wrap">
                  ...
                  <div className="w-full md:w-3/6 px-3 md:py-2">
                    ...
                    <MultiSelect
                      options={data?.region}
                      selectedValues={[resumeData?.region]}
                      isObject={false}
                  ...
                  <div className="w-full md:w-3/6 px-3 md:py-2">
                    ...
                    <input
                      className={`appearance-none block w-full text-themeDark ${
                        errors?.professionalTitle ? "!border-red-400" : ""
                      } border border-gray rounded py-2.5 px-3 leading-tight focus:outline-none focus:bg-white`}
                      id="grid-first-name"
                      type="text"
                  ...
                  <div className="w-full md:w-3/6 px-3 md:py-2">
                    ...
                    <MultiSelect
                      options={data?.skills}
                      isObject={false}
                      selectedValues={resumeData?.skills}
                      name="skills"
                      displayValue="name"
                      register={register}
                  ...
                  <div className="w-full px-3 md:py-2">
                    <label className="themeDark text-xs">Resume Content</label>
                    <textarea
                      className={`w-full h-36 ${
                        errors?.resumeContent ? "!border-red-400" : ""
                        ...
                        >
                          ...
                          <div className="absolute top-0 right-0">
                            <button
                              ...
                              type="button"
                              onClick={() =>
                                onRemoveUrlHandler(index, urlsRemove)
                              }
                            >
                              <IoMdClose />
                            </button>
                      ...
                      {educations.map((education, index) => (
                        ...
                        >
                          ...
                          <div className="!mb-3">
                            ...
                            <input
                              className={`appearance-none block w-full text-themeDark ${
                                errors?.educations?.[index]?.qualifications
                                  ? "!border-red-400"
                                  : ""
                              } border border-gray rounded py-2.5 px-3 leading-tight focus:outline-none focus:bg-white`}
                          ...
                          <div className="absolute top-0 right-0">
                            <button
                              ...
                              type="button"
                              onClick={() =>
                                onRemoveUrlHandler(index, educationRemove)
                              }
                            >
                              <IoMdClose />
                            </button>
                      ...
                      {experiences.map((education, index) => (
                        ...
                        >
                          <div className="!mb-3">
                            ...
                            <input
                              className={`appearance-none block w-full text-themeDark ${
                                errors?.experiences?.[index]?.employerName
                                  ? "!border-red-400"
                                  : ""
                              } border border-gray rounded py-2.5 px-3 leading-tight focus:outline-none focus:bg-white`}
                          ...
                          <div className="!mb-3">
                            ...
                            <textarea
                              className="h-28 appearance-none block w-full text-themeDark border border-gray rounded py-2.5 px-3 leading-tight focus:outline-none focus:bg-white"
                              id="grid-notes"
                              {...register(`experiences.${index}.notes`)}
                            />
                          </div>
                          {/* Cancel button */}
                          <div className="absolute top-0 right-0">
                            <button
                              ...
                              type="button"
                              onClick={() =>
                                onRemoveUrlHandler(index, experienceRemove)
                              }
                            >
                              <IoMdClose />
                            </button>
